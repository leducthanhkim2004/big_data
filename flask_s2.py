...
def upload_file():
    ...
    try:
        ...
        return f'File uploaded successfully using port 5001 with HDFS features. Blocks: {len(blocks)}, Replicas: {len(replication_map)}'
    except Exception as e:
        return f'File uploaded successfully using port 5001 (HDFS features failed: {str(e)})'
